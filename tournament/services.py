...
from .models import Tournament, Registration, Bracket, Match1vs1, Team, RegistrationTeam, Result, TournamentsInLeague, User, League
...
def create_tournament(
    ...
    tournament = Tournament(owner=owner, name=name, description=description, max_participants=max_participants,
                            ...
                            format=format, team_creation_mode=team_creation_mode)
